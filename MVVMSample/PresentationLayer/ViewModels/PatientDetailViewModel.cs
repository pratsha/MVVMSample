...
namespace MVVMSample.PresentationLayer.ViewModels
{
    ...
    public class PatientDetailViewModel: INotifyPropertyChanged
    {
        ...
        private MTObservableCollection<Patient> _patients;
        ...
        public PatientDetailViewModel()
        {
            ...
            _patients = new MTObservableCollection<Patient>();
        ...
        /// </summary>
        public MTObservableCollection<Patient> Patients
        {
        ...
        public void Add(object obj)
        {
            ...
            if (patientManager.Add(patient))
            {
                ...
                ResetPatient();
              //  var result=MessageBox.Show("Patient Add Successful !");
